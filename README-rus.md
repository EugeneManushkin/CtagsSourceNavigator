...
## Что нового
#### по сравнению с 2.1.0.11
+ Синхронизирована история загруженных tags файлов между несколькими одновременно работающими экземплярами Far Manager
+ Изменение конфигурации в одном из работающих экземпляров Far Manager вступает в силу сразу для всех работающих экземпляров Far Manager
#### по сравнению с 2.1.0.9
